...
**hyr** is an AI-powered tool that helps job seekers optimize their application materials for maximum ATS (Applicant Tracking System) compatibility while maintaining authenticity and human-like writing quality.
Navigate to https://github.com/raoljirushabh/hyr.me/blob/main/hyrd_Project_Doc.pptx fro more information.
## Features
